...
import { ArrowRight, Download, Send, Check, ChevronDown, Copy, Mail, Phone } from "lucide-react";
  ...
  return (
    <div ref={ref} className="relative">
      <button
        type="button"
        onClick={() => setOpen((o) => !o)}
        className={`w-full flex items-center justify-between gap-3 px-4 py-5 rounded-2xl text-sm text-left font-normal bg-white dark:bg-[#0d1f3c] border-2 outline-none transition-all duration-200 cursor-pointer ${
          open
            ? "border-[#C9A227] shadow-[0_0_0_4px_rgba(201,162,39,0.08)]"
            : "border-slate-200 dark:border-white/10 hover:border-slate-300 dark:hover:border-white/20"
        }`}
                  ...
                  <motion.button
                    ...
                    className={`w-full flex items-center justify-between gap-3 px-3 py-2.5 rounded-xl text-sm transition-all duration-150 text-left ${
                      isSelected
                        ...
                        : "text-[#0A1628] dark:text-slate-200 hover:bg-white dark:hover:bg-white/5"
                    }`}
                  >
          ...
          <div className="space-y-6 pt-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {clientLogos.map((client, idx) => (
                <div
                  key={idx}
                  className="tech-card rounded-2xl p-5 flex flex-col justify-between gap-4"
                >
                  {/* Logo */}
      ...
      <section className="bg-white dark:bg-[#050d1f] py-20 sm:py-28 px-4 sm:px-6 lg:px-8 transition-colors duration-300">
        <div className="max-w-7xl mx-auto">
          <SectionHeader
            ...
            description="A collection of writing, publications, press features, advocacy campaigns and documentary films."
          />
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 sm:gap-6">
            {[
              {
                title: "Campaigns",
                desc: "Advocacy and public-facing campaigns designed to raise awareness, engage audiences and encourage action.",
                tag: "Civic & Health Mobilization",
                filter: "Campaigns",
              },
              {
                title: "Creative NonFictions",
                desc: "Personal essays, human-centred narratives and observational writing drawn from real experiences and everyday life.",
                tag: "Essays & Literary Memoirs",
                filter: "Creative Non-Fictions",
              },
              {
                title: "Editorial",
                desc: "Reports, publications, compendiums and organisational documents that turn information and achievements into clear, readable stories.",
                tag: "Reports & Compendiums",
                filter: "Editorial",
              },
              {
                title: "Press",
                desc: "Press releases, statements, media briefs and other materials developed for public and media engagement.",
                tag: "Public Relations & Dispatches",
                filter: "Press",
              },
              {
                title: "Writing Samples",
                desc: "Selected long-form and professional writing, including research-based pieces, policy content, workshop materials and other commissioned work.",
                tag: "Legal Research & Policy",
                filter: "Writing Samples",
              },
              {
                title: "Documentaries & Visual Storytelling",
                desc: "Documentaries, short films, community field stories and visual advocacy capturing lived human experiences.",
                tag: "Advocacy Films & Field Chronicles",
                filter: "Documentaries & Visual Storytelling",
              },
            ].map((item, idx) => {
              return (
                <motion.div
                ...
                >
                  ...
                  >
                    <TiltCard className="h-full">
                      <div className="tech-card rounded-2xl p-6 h-full flex flex-col justify-between group-hover:border-[#C9A227] transition-all">
                        <div>
                          <h3 className="text-base font-bold text-[#0A1628] dark:text-white mb-2 group-hover:text-[#C9A227] transition-colors">
                            {item.title}
                          </h3>
                          <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed font-normal">
                            {item.desc}
            ...
            <div className="lg:col-span-5 space-y-6">
              <div className="tech-card rounded-3xl p-6 sm:p-8 space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between gap-3 p-4 rounded-lg bg-white dark:bg-slate-900/80 border border-slate-200 dark:border-white/10 hover:border-[#C9A227]/50 transition-all group">
                    <a
                      href="mailto:ezekweolivia@gmail.com"
                      className="flex items-center gap-3 flex-1 min-w-0"
                      title="Click to send email"
                    >
                      <div className=" text-[#C9A227] flex items-center justify-center shrink-0 border border-[#C9A227]/20">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-between gap-3 p-4 rounded-lg bg-white dark:bg-slate-900/80 border border-slate-200 dark:border-white/10 hover:border-emerald-500/50 transition-all group cursor-pointer"
                  >
                    ...
                    < Image src={WhatsappIcon} alt="WhatsApp" height={24} width={24}  className="w-8 h-6 flex-shrink-0" />
                    </span>
                  </a>
                </div>
