...
import { Film, Play, Clock, ChevronLeft } from 'lucide-react';
                    ...
                    <div>
                      ...
                      <div className="relative aspect-video w-full overflow-hidden bg-slate-900">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                          <div className="w-14 h-14 rounded-full bg-[#C9A227] text-[#0A1628] flex items-center justify-center shadow-lg transform group-hover:scale-110 transition-transform">
                        ...
                        <div className="absolute top-3 right-3 px-2 py-1 rounded-md bg-black/70 text-white font-mono text-[10px] flex items-center gap-1">
