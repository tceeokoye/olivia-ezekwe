        ...
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <div className="hidden sm:flex items-center gap-3">
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg text-xs font-semibold text-slate-700 dark:text-slate-200 hover:text-slate-900 dark:hover:text-white border border-slate-300 dark:border-white/15 hover:bg-slate-50 dark:hover:bg-white/5 transition-all"
            >
            ...
            <Link
              href="/#contact"
              className="inline-flex items-center gap-1.5 px-5 py-2 rounded-lg bg-[#0A1628] dark:bg-[#C9A227] hover:bg-slate-800 dark:hover:bg-[#d8b338] text-white dark:text-[#0A1628] font-bold text-xs tracking-wide shadow-sm hover:shadow transition-all duration-200"
            >
            ...
            >
              <div className="space-y-6">
                ...
                <div className="space-y-1">
                  ...
                  <a
                    ...
                    download="Olivia_Ezekwe_CV.txt"
                    onClick={() => setMobileMenuOpen(false)}
                    className="flex items-center justify-between px-4 py-3 rounded-lg text-sm font-semibold text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white"
                  >
                    <span>Download CV</span>
                  </a>
                </div>
              ...
              <div className="pt-4 border-t border-slate-100 dark:border-white/10 space-y-3">
                <Link
                  href="/#contact"
                  onClick={() => setMobileMenuOpen(false)}
                  className="w-full flex items-center justify-center gap-2 py-3 rounded-lg bg-[#0A1628] dark:bg-[#C9A227] text-white dark:text-[#0A1628] font-bold text-xs tracking-wide shadow-sm"
                >
                  <span>Get in Touch</span>
                </Link>
              </div>
